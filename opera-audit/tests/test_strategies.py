...
class TestForwardMapStrategy:
    ...
    def test_analyze_with_dswx_outputs(self, mock_cmr):
        ...
        # Expected: 4 HLS inputs
        assert results['expected'] == 4
        # Actual: 2 DSWx prefixes (T15SXR_20240101T180732Z, T15SYS_20240102T180732Z)
        # Missing: 2 HLS inputs (both T15SYS ones) didn't produce outputs
